...
urlpatterns = [
    ...
    # ---------- Hanna Mind ----------
    path('generate-prompt/', views.generate_prompt),
    # ---------- ---------- ---------- ---------- ----------

    # ---------- webhook for hanna anlytics ----------
    path('webhook_handler', views.webhook_handler, name='webhook_handler'),
    # ---------- ---------- ---------- ---------- ----------


    # ---------- Solution Hub ----------
    path('create-solution/', views.create_solution),
    path('delete-solution/', views.delete_solution),
    path('update-solution/', views.update_solution),
    # ---------- ---------- ---------- ---------- ----------

    # ---------- Smart Notes ----------
    path('create-collections/', views.create_collections),
    ...
    # ---- WARNING: CALL THIS WHEN IN DEV or TESTING!!!!!
